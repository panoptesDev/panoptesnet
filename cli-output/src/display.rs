use {
    ...
    solana_sdk::{
        clock::UnixTimestamp, hash::Hash, message::Message, native_token::lamports_to_pano,
...
pub fn build_balance_message_with_config(
    ...
    let value = if config.use_lamports_unit {
        ...
        let sol = lamports_to_pano(lamports);
...
pub fn write_transaction<W: io::Write>(
    ...
    if let Some(transaction_status) = transaction_status {
        ...
        writeln!(
            ...
            "{}  Fee: ◎{}",
            prefix,
            lamports_to_pano(transaction_status.fee)
        )?;
        assert_eq!(
            ...
            if !rewards.is_empty() {
                ...
                for reward in rewards {
                    ...
                    writeln!(
                        ...
                        format!("◎{:<18.9}", lamports_to_pano(reward.post_balance),)
                    )?;
                }
            }
        }
