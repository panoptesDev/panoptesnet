...
This guide describes how to add Solana's native token PANO to your cryptocurrency
exchange.
...
To accommodate a user's request to withdraw PANO, you must generate a Solana
...
run `solana airdrop 1` to obtain some devnet or testnet PANO for developement and testing.
