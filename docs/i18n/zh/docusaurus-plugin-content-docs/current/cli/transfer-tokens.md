...
```bash
$ solana-keygen new --outfile my_panoana_wallet.json   # 创建第一个文件系统钱包
产生新的密钥对
...
$ solana airdrop 10 DYw8jCTfwHNRJhhmFcbXvVDTqWMEVFBX6ZKUmG5CNSKK --url https://api.devnet.solana.com  # 空投 10 个 PANO 到我的钱包地址/公钥
...
如果您已经持有 PANO 并想要向其他人发送代币，您将需要密钥对的路径， 他们的 base58 编码公钥和准备发送的代币。 上述条件准备好了以后，您可以使用 `solana transfer` 命令来发送代币：
