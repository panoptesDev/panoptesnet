use {
    ...
    log::*,
    solana_clap_utils::input_parsers::{lamports_of_pano, value_of},
    panoptes_faucet::{
...
async fn main() {
    ...
    let per_time_cap = lamports_of_pano(&matches, "per_time_cap");
    let per_request_cap = lamports_of_pano(&matches, "per_request_cap");
